...
public:
   ...
   */
  CPVRChannelGroups* GetTV() const { return Get(ChannelType::TV); }

  /*!
   * @brief Get the radio channel groups.
   * @return The radio channel groups.
   */
  CPVRChannelGroups* GetRadio() const { return Get(ChannelType::RADIO); }
   ...
   */
  CPVRChannelGroups* Get(ChannelType type) const;
