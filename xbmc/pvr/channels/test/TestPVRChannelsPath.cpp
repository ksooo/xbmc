...
{
  PVR::CPVRChannelsPath path("pvr://channels/tv/Group1/1234_4711.pvr");

  EXPECT_EQ(static_cast<std::string>(path), "pvr://channels/tv/Group1/1234_4711.pvr");
  EXPECT_TRUE(path.IsValid());
  EXPECT_FALSE(path.IsEmpty());
  EXPECT_FALSE(path.IsRadio());
  EXPECT_FALSE(path.IsChannelsRoot());
  ...
  EXPECT_EQ(path.GetGroupName(), "Group1");
  EXPECT_EQ(path.GetClientID(), 1234);
...
TEST(TestPVRChannelsPath, Parse_Invalid_TV_Channel_1)
{
  ...
  PVR::CPVRChannelsPath path("pvr://channels/radio/Group1/1234_4711");
...
TEST(TestPVRChannelsPath, Parse_Invalid_TV_Channel_2)
{
  ...
  PVR::CPVRChannelsPath path("pvr://channels/radio/Group1/1234-4711.pvr");
...
TEST(TestPVRChannelsPath, Parse_Invalid_TV_Channel_3)
{
  ...
  PVR::CPVRChannelsPath path("pvr://channels/radio/Group1/1234_abc4711.pvr");
...
TEST(TestPVRChannelsPath, Parse_Invalid_TV_Channel_4)
{
  ...
  PVR::CPVRChannelsPath path("pvr://channels/radio/Group1/1234_-4711.pvr");
...
{
  // empty channeluid
  PVR::CPVRChannelsPath path("pvr://channels/radio/Group1/1234_.pvr");
...
{
  PVR::CPVRChannelsPath path(false, "Group1", 1234, 4711);
...
{
  PVR::CPVRChannelsPath path(true, "Group1", 1234, 4711);

  EXPECT_EQ(static_cast<std::string>(path), "pvr://channels/radio/Group1/1234_4711.pvr");
  EXPECT_TRUE(path.IsValid());
  EXPECT_FALSE(path.IsEmpty());
  EXPECT_TRUE(path.IsRadio());
  EXPECT_FALSE(path.IsChannelsRoot());
