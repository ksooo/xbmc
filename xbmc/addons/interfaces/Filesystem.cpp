                                         ...
                                         unsigned int* num_items)
{
  ...
  {
    CLog::LogF(LOGERROR,
               "Invalid data (addon='{}', path='{}', mask='{}', items='{}', num_items='{}'",
    ...
    void* kodiBase, const char* path, uint64_t* capacity, uint64_t* free, uint64_t* available)
{
  ...
  {
    CLog::LogF(LOGERROR,
               "invalid data (addon='{}', path='{}, capacity='{}, free='{}, available='{})",
                                         ...
                                         const char* useragent)
{
  ...
  {
    CLog::LogF(LOGERROR, "Invalid data (addon='{}', url='{}', content='{}', useragent='{}')",
                                                    ...
                                                    int* length)
{
  ...
  {
    CLog::LogF(LOGERROR, "Invalid data (addon='{}', handle='{}', param='{}', length='{}')",
    ...
    void* kodiBase, void* file, int type, const char* name, int* numValues)
{
  ...
  {
    CLog::LogF(LOGERROR, "invalid data (addon='{}', file='{}', name='{}', numValues='{}')",
