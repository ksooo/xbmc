...
public:
  ...
  ///
  /// @remarks Optional, and only used if both @ref PVRCapabilities::SetSupportsRecordings()
  /// and @ref PVRCapabilities::SetSupportsMultipleRecordedStreams() are set to true.
  ///
