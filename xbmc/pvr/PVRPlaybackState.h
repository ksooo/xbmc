...
public:
   ...
   * @param type RADIO, to get the active radio group, false to get the active TV group.
   ...
   * @param type RADIO, to get the radio group member, false to get the TV group member.
