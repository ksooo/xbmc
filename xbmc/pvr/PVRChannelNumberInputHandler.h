...
{
public:
  static constexpr size_t CHANNEL_NUMBER_INPUT_MAX_DIGITS = 5;
   ...
   */
  CPVRChannelNumberInputHandler(int iDelay, size_t maxDigits = CHANNEL_NUMBER_INPUT_MAX_DIGITS);
