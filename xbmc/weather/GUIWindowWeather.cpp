...
void CGUIWindowWeather::UpdateButtons()
{
  ...
  {
    SET_CONTROL_LABEL(CONTROL_LABELD0DAY + (i * 10), wmgr.GetDayProperty(i, "Title"));
    SET_CONTROL_LABEL(CONTROL_LABELD0HI + (i * 10), wmgr.GetDayProperty(i, "HighTemp"));
    SET_CONTROL_LABEL(CONTROL_LABELD0LOW + (i * 10), wmgr.GetDayProperty(i, "LowTemp"));
    SET_CONTROL_LABEL(CONTROL_LABELD0GEN + (i * 10), wmgr.GetDayProperty(i, "Outlook"));
    SET_CONTROL_FILENAME(CONTROL_IMAGED0IMG + (i * 10), wmgr.GetDayProperty(i, "OutlookIcon"));
  }
}
