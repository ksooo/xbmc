...
extern "C" {
  ...
  const unsigned int PVR_TIMER_TYPE_SUPPORTS_RECORD_ONLY_NEW_EPISODES = 0x0400; /*!< @brief this type supports the "record only new episodes" feature (PVR_TIMER.bNewEpisodesOnly) */
  ...
  typedef struct PVR_TIMER_TYPE
  {
    ...
    char strDescription[PVR_ADDON_DESC_STRING_LENGTH]; /*!< @brief (optional) a short localized string describing the purpose of the type. (e.g.
