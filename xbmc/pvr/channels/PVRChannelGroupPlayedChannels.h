...
class CPVRChannelGroupPlayedChannels : public CPVRChannelGroup
{
public:
  /*!
   ...
   */
  CPVRChannelGroupPlayedChannels(const CPVRChannelsPath& path,
   ...
   */
  int GroupType() const override { return PVR_GROUP_TYPE_SYSTEM_PLAYED_CHANNELS; }
