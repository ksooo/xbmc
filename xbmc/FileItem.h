...
public:
  ...
  inline const std::shared_ptr<PVR::CPVRRadioRDSInfoTag> GetPVRRadioRDSInfoTag() const
  {
    return m_pvrRadioRDSInfoTag;
  }

  inline void SetPVRRadioRDSInfoTag(const std::shared_ptr<PVR::CPVRRadioRDSInfoTag>& tag)
  {
...
private:
  ...
  std::shared_ptr<PVR::CPVRRadioRDSInfoTag> m_pvrRadioRDSInfoTag;
