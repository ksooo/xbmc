...
namespace PVR
{
  ...
  public:
    ...
    std::shared_ptr<CFileItem> GetSelectedChannelItem() const;
  ...
  protected:
    ...
    int GetBlock(const std::shared_ptr<CGUIListItem> &item, int channel);
    int GetRealBlock(const std::shared_ptr<CGUIListItem> &item, int channel);
