...
#define VIDEODB_DETAILS_MOVIE_PART_NUMBER       VIDEODB_MAX_COLUMNS + 15
...
#define VIDEODB_DETAILS_EPISODE_PART_NUMBER     VIDEODB_MAX_COLUMNS + 18
#define VIDEODB_DETAILS_EPISODE_RATING          VIDEODB_MAX_COLUMNS + 19
#define VIDEODB_DETAILS_EPISODE_VOTES           VIDEODB_MAX_COLUMNS + 20
#define VIDEODB_DETAILS_EPISODE_RATING_TYPE     VIDEODB_MAX_COLUMNS + 21
#define VIDEODB_DETAILS_EPISODE_UNIQUEID_VALUE  VIDEODB_MAX_COLUMNS + 22
#define VIDEODB_DETAILS_EPISODE_UNIQUEID_TYPE   VIDEODB_MAX_COLUMNS + 23
...
#define VIDEODB_DETAILS_MUSICVIDEO_PART_NUMBER  VIDEODB_MAX_COLUMNS + 12
#define VIDEODB_DETAILS_MUSICVIDEO_UNIQUEID_VALUE VIDEODB_MAX_COLUMNS + 13
#define VIDEODB_DETAILS_MUSICVIDEO_UNIQUEID_TYPE  VIDEODB_MAX_COLUMNS + 14
// clang-format on
...
private:
  ...
  std::vector<std::string> GetDiscImageStackURLs(const std::string& fileNameAndPath);
};
